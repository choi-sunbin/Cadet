...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/30 18:49:04 by sunbchoi          #+#    #+#             */
/*   Updated: 2021/12/05 00:32:52 by sunbchoi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	philo_eats(t_philo *philo)
{
	...
	take_sleep_time(rules->time_to_eat, rules);
	(philo->eaten_cnt)++;
...
void	*p_thread(void *void_philosopher)
{
	...
	while (!(rules-> dieded))
	{
		...
		take_sleep_time(rules->time_to_sleep, rules);
